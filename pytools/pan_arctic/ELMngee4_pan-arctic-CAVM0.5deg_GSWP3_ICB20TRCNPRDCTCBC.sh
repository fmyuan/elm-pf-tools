...
CASEDIR="/gpfs/wolf2/cades/cli185/proj-shared/$USER/project-e3sm/cases/ELMngee4_pan-arctic-CAVM0.5deg_GSWP3_ICB1850CNPRDCTCBC"

/gpfs/wolf2/cades/cli185/proj-shared/f9y/models/E3SM_ORNL_IM/cime/scripts/create_newcase --case "${CASEDIR}" --mach cades-baseline --compset ICB1850CNPRDCTCBC --res ELM_USRDAT --mpilib openmpi-amanzitpls --walltime 24:0:00 --handle-preexisting-dirs u --project e3sm --compiler gnu
...
&clm_inparm
 ...
 finidat = '/gpfs/wolf2/cades/cli185/scratch/f9y/ELMngee4_pan-arctic-CAVM0.5deg_GSWP3_ICB1850CNRDCTCBC_ad_spinup/run/ELMngee4_pan-arctic-CAVM0.5deg_GSWP3_ICB1850CNPRDCTCBC.elm.r.0601-01-01-000000.nc'
">>user_nl_elm
